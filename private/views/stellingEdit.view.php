                ...
                <div class="col-md-6 col-sm-8">
                        ...
                        <input type="hidden" name="id" value="<?=$data[0]->id;?>">
                                ...
                                <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="w3review" name="statement" rows="4" cols="50" ><?=$data[0]->text;?></textarea>                                </div>
                                
                                <div class="mb-3">
                                        <label for="partijNaam" class="form-label">Richting</label>

                                        <div class="input-group mb-3">
                                                <select class="form-select" id="inputGroupSelect03" name="direction" value="<?=$data[0]->political_direction;?>" aria-label="Example select with button addon">
                                ...
                                <input type="submit" name="submit" id="aanmaken" class="succes_btn" value="update">
                        </form>
                </div>
                <div class="col-md-3 col-sm-2">
                </div>
