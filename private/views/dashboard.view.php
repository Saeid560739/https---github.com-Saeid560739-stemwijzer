            ...
            <div class="" id="navbarNavAltMarkup">
                ...
                <?php foreach( $data as $key => $value ):?>
                    <tbody>
                        ...
                        <td style="width:20%">
                            <a href="http://localhost/stemwijzer/public/partijEdit?id=<?=$value->id;?>" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
